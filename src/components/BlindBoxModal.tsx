...
const FALLBACK_JOKES = [
  ...
  // ── 命運宇宙系 ──
  '月亮說：把書帶回家。月亮不會錯的。',
  '你以為你在選書？其實是書在面試你，而你已錄取。',
  '三個月後你會慶幸今天遇見了它。',
  '這本書等你等了很久，終於在今天找到你了。',
  '星座不準，但這次抽籤絕對準。',
  '它只願意跟你走。你不帶它，它會難過的。',
  '世界上所有的隨機都是假象，這一本是真命運。',
  '不是你選了書，是書選中了靈魂相契的你。',
  '天意如此，抗拒只會消耗自己的能量。',
  // ── 幽默勸讀系 ──
  '不讀完，它會在你夢裡出現的。',
  '圖書館員工作了三十年，他說：這本就是你的那本。',
  '你的書架上已經預留了它的位置，趕緊填上。',
  '與其在網路上滑三小時，不如把這本讀完，效益比你想的高。',
  '你的老闆不會知道你在讀書充實自己。但你的未來自己會感謝你。',
  '讀完它，你就可以在聚會時說：「我最近在讀一本書……」',
  '咖啡已備好，沙發已等候，就差這本書了。',
  '再不讀，它要去找下一個有緣人了。',
  '這本書的訊息是：「來，我不咬人。」',
  // ── 哲學玄學系 ──
  '莊子說：「子非我，安知我不知書之樂？」就是說你，讀就對了。',
  '人生有三件事不能拖：看病、致歉，還有讀這本書。',
  '有些相遇沒有原因，只有意義。',
  '書和人一樣，對的時間遇見，才知道彼此的好。',
  '古人云：開卷有益。古人從未讓你失望過。',
  '它是一扇門，而你正好站在門口。',
  '命運不一定對，但今天它恰好對了。',
  '有些書不是用來讀的，是用來改變你的。這本就是。',
  // ── 輕鬆撒嬌系 ──
  '不帶它走？那誰來帶它走？',
  '你看它，它也在看你，多浪漫。',
  '它已經在你手機螢幕上露面了，這叫緣分。',
  ...
  '好書像好朋友，遇到了別讓它走。',
  '它的封面在說：「帶我回家，我是認真的。」',
  '館員偷偷說這本超好看，但他說要保密。（我沒說。）',
  // ── 反差萌系 ──
  '你今天本來只是要隨便看看，結果命運要你認真一下。',
  '抽到這本的人，通常比平均值聰明。（統計學意義不大，但聽著開心。）',
  '你不是在逃避現實，你是在充電。這本書就是插頭。',
  '它沒有追蹤你的演算法，但它就是對你的胃口。',
  '讀書這件事，最適合從現在這一秒開始。',
  '不知道讀什麼？命運已經替你決定了，省了你三十分鐘選書。',
  // ── 溫柔勵志系 ──
  '慢慢讀，不急。好書值得被好好對待。',
  '翻開第一頁，世界會稍微不一樣。',
  '你有能力讀懂它，它也有故事等你來讀。',
  '願你讀完後，帶著一點新的什麼繼續往前走。',
  '好的書讀完之後，你會捨不得它結束。希望這本就是。',
];
